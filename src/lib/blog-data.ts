...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: "energia-en-aysen",
    num: "01",
    title: "En Aysén pagamos la energía más cara. Y tenemos cómo cambiarlo",
    subtitle: "Columna de opinión sobre por qué el costo energético frena a la Patagonia y qué podemos hacer hoy para revertirlo.",
    author: "Bruno Ortega",
  ...
  {
    slug: "patagonia-no-se-entiende",
    num: "02",
    title: "La Patagonia no se entiende desde Santiago",
    subtitle: "Por qué la pertenencia territorial no es un eslogan, sino una ventaja técnica real a la hora de hacer ingeniería.",
  ...
  },
  {
    ...
    subtitle: "Qué es Enma, qué hace y a quién ayuda, contado en simple y sin tecnicismos.",
    author: "Equipo Enma",
    role: "",
    category: "Identidad",
